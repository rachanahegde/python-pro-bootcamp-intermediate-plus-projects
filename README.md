...
This project involved using selenium webdriver to open LinkedIn, log in, and apply for all jobs that meet my criteria (including Easy Apply). While this is an interesting strategy automating the job application process on LinkedIn, coding the app bot proved to be far more complicated than I anticipated. Selenium threw up exceptions and errors at nearly every step of the process and I implemented WebdriverWait and expected conditions to address the most common NoSuchElementException.
